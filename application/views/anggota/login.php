            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?php echo base_url('anggota/login/proses_login')?>">
                    ...
                    <div class="g-recaptcha" data-sitekey="6LcT1PEUAAAAADeMbYLtKneWxLnIdXljwSVnV0yO"></div>
        <br>
        <br>
